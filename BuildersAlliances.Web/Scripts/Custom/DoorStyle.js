$(document).ready(function () {
    ...
    $(".FilterSearch").keyup(function () {
       ...
       // var FilterSearch = $(this).val();
            ...
            $('#RefreshDoorGrid').bootstrapTable('filterBy');
...
function RefreshDoorGrid() {
    $('#doorgrid').bootstrapTable('refresh', { silent: true });
